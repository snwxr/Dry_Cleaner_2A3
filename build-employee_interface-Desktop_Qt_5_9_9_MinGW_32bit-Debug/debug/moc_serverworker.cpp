...
#include "../../employee_interface/serverworker.h"
...
void ServerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ServerWorker *_t = static_cast<ServerWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ServerWorker::*_t)(const QJsonObject & );
        ...
        {
            typedef void (ServerWorker::*_t)(const QString & );
...
const QMetaObject ServerWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ServerWorker.data,
      qt_meta_data_ServerWorker,  qt_static_metacall, nullptr, nullptr}
};
